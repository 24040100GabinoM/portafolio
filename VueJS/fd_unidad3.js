// Componente global para Unidad 3 (seguridad e implementación)
window.FdUnidad3 = {
  template: `
  <div>
    <header>
    ...
    <main class="container">
      <h2>Unidad 3: Proceso de Desarrollo de Seguridad e implementacion</h2>
      <p>Contenido de la unidad 3 (seguridad e implementación). Aquí se agregará información en el futuro.</p>
    </main>
